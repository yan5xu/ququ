...
- **FunASR** - 阿里巴巴开源的语音识别工具包
  ...
  - FSMN-VAD模型 (语音端点检测)
- **可配置AI模型** - 支持OpenAI、Anthropic、阿里云通义千问等多种AI服务商 (负责标点恢复和文本优化)
...
- **智能标点恢复** - 使用AI模型自动添加标点符号
- **音频格式支持** - 支持多种音频格式输入

### AI文本处理
- **智能标点恢复** - 使用AI模型自动添加合适的标点符号
- **语音识别优化** - 纠正ASR可能出现的错误和错别字
- **文本格式化** - 自动整理文本格式和段落结构
- **语法纠错** - 修正语音识别中的语法错误
- **内容优化** - 提升文本的流畅性和专业性，去除口语化表达
- **多种处理模式** - 支持ASR增强、格式化、纠错、优化、总结等不同模式
